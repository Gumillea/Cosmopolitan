...
public class CosmoItemTags {
    ...
    public static final TagKey<Item> EDIBLE_FLOWERS = TagUtil.itemTag("cosmopolitan", "edible_flowers");
    ...
    public static final TagKey<Item> SPRING_CROPS = TagUtil.itemTag("sereneseasons", "spring_crops");
    public static final TagKey<Item> SUMMER_CROPS = TagUtil.itemTag("sereneseasons", "summer_crops");
    public static final TagKey<Item> AUTUMN_CROPS = TagUtil.itemTag("sereneseasons", "autumn_crops");
    public static final TagKey<Item> WINTER_CROPS = TagUtil.itemTag("sereneseasons", "winter_crops");
