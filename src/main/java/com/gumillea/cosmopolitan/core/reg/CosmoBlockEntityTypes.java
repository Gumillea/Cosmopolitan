...
public class CosmoBlockEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<FrozenDessertTubBlockEntity>> FROZEN_DESSERT_TUB = HELPER.createBlockEntity("frozen_dessert_tub", FrozenDessertTubBlockEntity::new, () -> Set.of(CosmoBlocks.COPPER_FROZEN_DESSERT_TUB.get(), CosmoBlocks.IRON_FROZEN_DESSERT_TUB.get(), CosmoBlocks.NETHERITE_FROZEN_DESSERT_TUB.get()));
}