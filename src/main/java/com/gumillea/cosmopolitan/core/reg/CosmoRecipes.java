...
public class CosmoRecipes {
    ...
    public static final RegistryObject<RecipeType<TubInjectRecipe>> TUB_INJECT_TYPE = RECIPE_TYPE.register("tub_injecting", () -> RecipeType.simple(ResourceLocation.fromNamespaceAndPath(Cosmopolitan.MODID, "tub_injecting")));
    ...
    public static final RegistryObject<RecipeType<TubInteractingRecipe>> TUB_INTERACTING_TYPE = RECIPE_TYPE.register("tub_interacting", () -> RecipeType.simple(ResourceLocation.fromNamespaceAndPath(Cosmopolitan.MODID, "tub_interacting")));
    ...
    public static final RegistryObject<RecipeType<TubExtractRecipe>> TUB_EXTRACT_TYPE = RECIPE_TYPE.register("tub_extracting", () -> RecipeType.simple(ResourceLocation.fromNamespaceAndPath(Cosmopolitan.MODID, "tub_extracting")));
}
