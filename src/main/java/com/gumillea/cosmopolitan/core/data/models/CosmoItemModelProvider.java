...
public class CosmoItemModelProvider extends BlueprintItemModelProvider {
    ...
    protected void registerModels() {
        this.generatedItem(
                CosmoItems.SUMMER_CORDIAL, CosmoItems.WINTER_GLOGG, CosmoItems.AUTUMN_TEA, CosmoItems.BIRCH_SAP_BOTTLE, CosmoItems.SPRING_SODA, CosmoItems.SPROUTED_UNDERBEANS, CosmoItems.CLASSIC_ICE_CREAM, CosmoItems.CLASSIC_ICE_CREAM_SANDWICH, CosmoItems.CLASSIC_FRUIT_SALAD, CosmoItems.TOFFEE_GOLDEN_APPLE, CosmoItems.JELLY_CUP, CosmoItems.MAGMA_JELLY_CUP,CosmoItems.WILDBERRY, CosmoItems.BERRY_SYRUP_BOTTLE, CosmoItems.JELLY_ROLL, CosmoItems.JELLY_ROLL_SLICE, CosmoItems.CHOCOLATE_ROLL, CosmoItems.CHOCOLATE_ROLL_SLICE, CosmoItems.COSMOPOLITAN_COCKTAIL, CosmoItems.FIDDLEHEAD, CosmoItems.BAKED_FIDDLEHEAD, CosmoItems.GREEN_SAUCE, CosmoItems.WAFER,
