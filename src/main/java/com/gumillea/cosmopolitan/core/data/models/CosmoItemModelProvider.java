...
public class CosmoItemModelProvider extends BlueprintItemModelProvider {
    ...
    protected void registerModels() {
        this.generatedItem(
                CosmoItems.JELLY_CUP, CosmoItems.MAGMA_JELLY_CUP,CosmoItems.WILDBERRY, CosmoItems.BERRY_SYRUP_BOTTLE, CosmoItems.JELLY_ROLL, CosmoItems.JELLY_ROLL_SLICE, CosmoItems.CHOCOLATE_ROLL, CosmoItems.CHOCOLATE_ROLL_SLICE, CosmoItems.COSMOPOLITAN_COCKTAIL, CosmoItems.FIDDLEHEAD, CosmoItems.BAKED_FIDDLEHEAD, CosmoItems.GREEN_SAUCE, CosmoItems.WAFER,
