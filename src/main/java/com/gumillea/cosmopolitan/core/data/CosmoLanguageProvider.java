...
public class CosmoLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addSlice(
                CosmoItems.YULE_LOG_SLICE.get(), CosmoItems.SHOOFLY_PIE_SLICE.get(), CosmoItems.WATER_PIE_SLICE.get(), CosmoItems.JELLY_ROLL_SLICE.get(), CosmoItems.CHOCOLATE_ROLL_SLICE.get(), CosmoItems.INK_ROLL_SLICE.get()
        );
