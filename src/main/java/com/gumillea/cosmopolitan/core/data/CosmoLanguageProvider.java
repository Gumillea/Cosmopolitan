...
public class CosmoLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addTradeItem(
                CosmoItems.TRAVELERS_PANINI.get()
        );
