...
public class CosmoLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addBlock(
                CosmoBlocks.SAPPY_BIRCH_LOG.get(), CosmoBlocks.LIFELIGHT.get(), CosmoBlocks.COPPER_FROZEN_DESSERT_TUB.get(), CosmoBlocks.IRON_FROZEN_DESSERT_TUB.get(), CosmoBlocks.NETHERITE_FROZEN_DESSERT_TUB.get(), CosmoBlocks.MASHED_POTATO_BLOCK.get(), CosmoBlocks.WHEATGRASS_BALE.get(),
        ...
        this.add("tooltip." + Cosmopolitan.MODID + ".seasonal_drink.when_drinking.cold", "Remove Fire");
        this.add("tooltip." + Cosmopolitan.MODID + ".seasonal_drink.when_drinking.hot", "Remove Freeze");

        this.add("tooltip." + Cosmopolitan.MODID + ".seasonal_drink.when_drinking.in_spring", "When drinking in Spring:");
        this.add("tooltip." + Cosmopolitan.MODID + ".seasonal_drink.when_drinking.in_summer", "When drinking in Summer:");
        this.add("tooltip." + Cosmopolitan.MODID + ".seasonal_drink.when_drinking.in_autumn", "When drinking in Autumn:");
        this.add("tooltip." + Cosmopolitan.MODID + ".seasonal_drink.when_drinking.in_winter", "When drinking in Winter:");
