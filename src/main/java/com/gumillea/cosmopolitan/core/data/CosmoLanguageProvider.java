...
public class CosmoLanguageProvider extends LanguageProvider {
    ...
    private void addPotion(Potion... potions) {
        for (Potion potion : potions) {
            ...
            add(key, "Potion " + format(id).replace(" Long", "").replace(" Strong", ""));
        }
    }
